...
import logoIcon from '../../assets/images/users/teamflow-icon.png';
...
export default function LogoIcon() {
  ...
  // return(
  //   <img src="../../assets/images/users/teamflow-logo.png" alt="" srcset="" />
  // );
  return (
    <img src={logoIcon} alt="TeamFlow" width="35" />
    // <img src={'../../assets/images/users/teamflow-logo.png'} alt="TeamFlow" width="100" height="100" />
